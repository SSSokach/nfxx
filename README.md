...
该脚本会**清空所有表并重建**，包含以下场景化数据：

| 数据类型 | 数量 | 说明 |
|---|---|---|
| 用户 | 5人 | 张三/李四/王五/赵六/郑十（技术部/产品部/设计部） |
| 联系人 | 4个 | 全员周报群、项目组（群聊）+ 2个私聊 |
| 消息 | 22条 | 周报通知、@提醒、催办消息、接口联调讨论、私聊 |
| 在线表单 | 2个 | 「7月工作汇报」3/5完成；「测试文件260720」含部分填写场景 |
| 待办 | 7条 | 含 pending/completed/overdue 三种状态 |
| 邮件 | 3封 | 通知+回复+催办提醒，含邮件追踪 |
| AI总结场景 | - | 李四填2/4列、赵六填1/4列、郑十填3/4列，可验证AI逐列检测能力 |
